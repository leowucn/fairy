const config = {
  ...
  maxConcurrentNumOfMusicForGetMusicInfo: 40,     // 并发更新音乐评论数的歌曲数目
  maxConcurrentNumGetArtistInfo: 20,              // 并发获取歌手信息的数目
  maxConcurrentNumOfSingerForGetAlbum: 20,        // 要并发抓取专辑的歌手的数目
